...
class SavingsAccount(Account):
    """Savings Account with interest application."""
...
class HighInterestSavingsAccount(SavingsAccount):
    ...
    def __init__(self, account_number, holder_name, balance=0):
        super().__init__(account_number, holder_name, balance, interest_rate=0.05)
...
class PremiumOverdraftCheckingAccount(OverdraftCheckingAccount):
    ...
    def deposit(self, amount):
        ...
        print(f"Earned cashback of ${cashback}. New balance: ${self.balance}")
